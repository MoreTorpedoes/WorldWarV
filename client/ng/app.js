...
angular.module('WorldWarV').controller('RoomCtrl', function ($log, $scope, $location, primus) {
  $scope.room = {};
  $scope.error = null;
...
angular.module('WorldWarV').controller('GameCtrl', function ($log, $scope, $location, primus) {
